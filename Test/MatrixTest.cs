...
namespace PDFTest
{
    ...
    public class MatrixTest
    {
        ...
        {
            CollectionAssert.AreEqual(new Matrix().Mult(new Matrix(2, 3, 3, 1, 6, 5)).GetValues(),
                                      new Matrix(2, 3, 3, 1, 6, 5).GetValues());
            CollectionAssert.AreEqual(new Matrix(2, 3, 3, 1, 6, 5).Mult(new Matrix()).GetValues(),
                                      new Matrix(2, 3, 3, 1, 6, 5).GetValues());
        }
        ...
        {
            CollectionAssert.AreEqual(new Matrix(2, 3, 3, 1, 6, 5).Mult(Matrix.Translate(3, 2))
                                                                  .Mult(Matrix.Scale(4, 6))
                                                                  .Mult(new Matrix())
                                                                  .GetValues(),
        ...
        {
            CollectionAssert.AreEqual(new Matrix(10, 0, 3, 0, 6, 5).Mult(Matrix.Translate(0, 2))
                                                                   .Mult(Matrix.Scale(4, 0))
                                                                   .Mult(new Matrix())
                                                                   .GetValues(),
        ...
        public void MultCombineVectorByMatrix()
        {
            ...
            Matrix.Translate(3, 2).Mult(Matrix.Scale(4, 6))
